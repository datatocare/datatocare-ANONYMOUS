...
def start():
    print("Pipeline started for evaluation row 4 experiment of using a time horizon of 2 hours for treatment prediction.")
...
def stop(conn, cur):
    ...
    print("Pipeline ended for evaluation row 4 experiment of using a time horizon of 2 hours for treatment prediction.")
...
if __name__ == "__main__":
    ...
    print('calculating overall results (precision, recall, F1-score) for evaluation row 4 experiment of using a time horizon of 2 hours for treatment prediction.')
