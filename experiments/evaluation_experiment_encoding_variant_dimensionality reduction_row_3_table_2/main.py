...
def start():
    print("Pipeline started for evaluation row 3 experiment of using dimensionality reduced encoding variant.")
...
def stop(conn, cur):
    ...
    print("Pipeline ended for evaluation row 3 experiment of using dimensionality reduced encoding variant.")
...
if __name__ == "__main__":
    ...
    print('calculating overall results (precision, recall, F1-score) for evaluation row 3 experiment of using dimensionality reduced encoding variant.')
