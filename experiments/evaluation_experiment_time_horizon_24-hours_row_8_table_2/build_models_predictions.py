...
def cal_potential_results(hadm_id):
	...
	for s in states:
		...
		print('************Potential Actual Treatments in next 24 hours***************')
		print(ta)
		print('********************************************')
		print('************Predicted Treatments in next 24 hours************')
		print(tp)
		print('********************************************')
...
def build_attributes_model_predict(ddmtr_df,ttr_df,ddmtte_df,cols_mddt,treat,times,states,hadm_id):
	...
	X_train,Y_train_24,X_test,Y_test_24 = build_attributes_label(ddmtr_df,ttr_df,ddmtte_df,cols_mddt,treat)

	print('Building model for treatment : ' + str(treat))
	build_model(X_train,Y_train_24,X_test,Y_test_24,times,states,treat,hadm_id,24)
