...
def start():
    print("Pipeline started for evaluation row 13 experiment of using Criterion-3 to find similar patient set.")
...
def stop(conn, cur):
    ...
    print("Pipeline ended for evaluation row 13 experiment of using Criterion-3 to find similar patient set.")
...
if __name__ == "__main__":
    ...
    print('calculating overall results (precision, recall, F1-score) for evaluation row 13 experiment of using Criterion-3 to find similar patient set.')
